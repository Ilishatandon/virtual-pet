...
if(lastFed>=12){text("lastfeed"+lastFed%12+"pm",350,30)}
else if(lastFed===0){text("lastfeed:12pm",350,30)}
 else {text("lastfeed"+lastFed+"am",350,30)}
  drawSprites();
}
...
else{ foodObj.updateFoodStock(i-1)}
